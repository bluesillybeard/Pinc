...
// This fill WILL NOT export any C symbols, although the implementations of some C functions are here.
...
pub fn Common(NativeWindow: type) type {
    return struct {
        ...
        pub var windows: std.ArrayList(?PincWindow) = undefined;
        ...
        pub fn pinc_common_init(window_api: c.pinc_window_api_enum, graphics_api: c.pinc_graphics_api_enum, allocator: std.mem.Allocator, nativeInit: fn(c.pinc_graphics_api_enum) callconv(.C) bool) bool {
            _ = window_api;
        ...
        pub fn pinci_send_event(event: c.pinc_event_union_t) callconv(.C) void {
            switch (event.type) {
                c.pinc_event_none => {},
        ...
        pub fn pinc_event_union(clear: bool) c.pinc_event_union_t {
