...
void loadXkb(void *(*load_fn)(const char* name)) {
    src_XkbIgnoreExtension = (PFN_XkbIgnoreExtension)load_fn("XkbIgnoreExtension");
    src_XkbOpenDisplay = (PFN_XkbOpenDisplay)load_fn("XkbOpenDisplay");
    src_XkbQueryExtension = (PFN_XkbQueryExtension)load_fn("XkbQueryExtension");
    src_XkbUseExtension = (PFN_XkbUseExtension)load_fn("XkbUseExtension");
    src_XkbLibraryVersion = (PFN_XkbLibraryVersion)load_fn("XkbLibraryVersion");
    src_XkbSetXlibControls = (PFN_XkbSetXlibControls)load_fn("XkbSetXlibControls");
    src_XkbGetXlibControls = (PFN_XkbGetXlibControls)load_fn("XkbGetXlibControls");
    src_XkbXlibControlsImplemented = (PFN_XkbXlibControlsImplemented)load_fn("XkbXlibControlsImplemented");
    src_XkbSetAtomFuncs = (PFN_XkbSetAtomFuncs)load_fn("XkbSetAtomFuncs");
    src_XkbKeycodeToKeysym = (PFN_XkbKeycodeToKeysym)load_fn("XkbKeycodeToKeysym");
    src_XkbKeysymToModifiers = (PFN_XkbKeysymToModifiers)load_fn("XkbKeysymToModifiers");
    src_XkbLookupKeySym = (PFN_XkbLookupKeySym)load_fn("XkbLookupKeySym");
    src_XkbLookupKeyBinding = (PFN_XkbLookupKeyBinding)load_fn("XkbLookupKeyBinding");
    src_XkbTranslateKeyCode = (PFN_XkbTranslateKeyCode)load_fn("XkbTranslateKeyCode");
    src_XkbTranslateKeySym = (PFN_XkbTranslateKeySym)load_fn("XkbTranslateKeySym");
    src_XkbSetAutoRepeatRate = (PFN_XkbSetAutoRepeatRate)load_fn("XkbSetAutoRepeatRate");
    src_XkbGetAutoRepeatRate = (PFN_XkbGetAutoRepeatRate)load_fn("XkbGetAutoRepeatRate");
    src_XkbChangeEnabledControls = (PFN_XkbChangeEnabledControls)load_fn("XkbChangeEnabledControls");
    src_XkbDeviceBell = (PFN_XkbDeviceBell)load_fn("XkbDeviceBell");
    src_XkbForceDeviceBell = (PFN_XkbForceDeviceBell)load_fn("XkbForceDeviceBell");
    src_XkbDeviceBellEvent = (PFN_XkbDeviceBellEvent)load_fn("XkbDeviceBellEvent");
    src_XkbBell = (PFN_XkbBell)load_fn("XkbBell");
    src_XkbForceBell = (PFN_XkbForceBell)load_fn("XkbForceBell");
    src_XkbBellEvent = (PFN_XkbBellEvent)load_fn("XkbBellEvent");
    src_XkbSelectEvents = (PFN_XkbSelectEvents)load_fn("XkbSelectEvents");
    src_XkbSelectEventDetails = (PFN_XkbSelectEventDetails)load_fn("XkbSelectEventDetails");
    src_XkbNoteMapChanges = (PFN_XkbNoteMapChanges)load_fn("XkbNoteMapChanges");
    src_XkbNoteNameChanges = (PFN_XkbNoteNameChanges)load_fn("XkbNoteNameChanges");
    src_XkbGetIndicatorState = (PFN_XkbGetIndicatorState)load_fn("XkbGetIndicatorState");
    src_XkbGetDeviceIndicatorState = (PFN_XkbGetDeviceIndicatorState)load_fn("XkbGetDeviceIndicatorState");
    src_XkbGetIndicatorMap = (PFN_XkbGetIndicatorMap)load_fn("XkbGetIndicatorMap");
    src_XkbSetIndicatorMap = (PFN_XkbSetIndicatorMap)load_fn("XkbSetIndicatorMap");
    src_XkbGetNamedIndicator = (PFN_XkbGetNamedIndicator)load_fn("XkbGetNamedIndicator");
    src_XkbGetNamedDeviceIndicator = (PFN_XkbGetNamedDeviceIndicator)load_fn("XkbGetNamedDeviceIndicator");
    src_XkbSetNamedIndicator = (PFN_XkbSetNamedIndicator)load_fn("XkbSetNamedIndicator");
    src_XkbSetNamedDeviceIndicator = (PFN_XkbSetNamedDeviceIndicator)load_fn("XkbSetNamedDeviceIndicator");
    src_XkbLockModifiers = (PFN_XkbLockModifiers)load_fn("XkbLockModifiers");
    src_XkbLatchModifiers = (PFN_XkbLatchModifiers)load_fn("XkbLatchModifiers");
    src_XkbLockGroup = (PFN_XkbLockGroup)load_fn("XkbLockGroup");
    src_XkbLatchGroup = (PFN_XkbLatchGroup)load_fn("XkbLatchGroup");
    src_XkbSetServerInternalMods = (PFN_XkbSetServerInternalMods)load_fn("XkbSetServerInternalMods");
    src_XkbSetIgnoreLockMods = (PFN_XkbSetIgnoreLockMods)load_fn("XkbSetIgnoreLockMods");
    src_XkbVirtualModsToReal = (PFN_XkbVirtualModsToReal)load_fn("XkbVirtualModsToReal");
    src_XkbComputeEffectiveMap = (PFN_XkbComputeEffectiveMap)load_fn("XkbComputeEffectiveMap");
    src_XkbInitCanonicalKeyTypes = (PFN_XkbInitCanonicalKeyTypes)load_fn("XkbInitCanonicalKeyTypes");
    src_XkbAllocKeyboard = (PFN_XkbAllocKeyboard)load_fn("XkbAllocKeyboard");
    src_XkbFreeKeyboard = (PFN_XkbFreeKeyboard)load_fn("XkbFreeKeyboard");
    src_XkbAllocClientMap = (PFN_XkbAllocClientMap)load_fn("XkbAllocClientMap");
    src_XkbAllocServerMap = (PFN_XkbAllocServerMap)load_fn("XkbAllocServerMap");
    src_XkbFreeClientMap = (PFN_XkbFreeClientMap)load_fn("XkbFreeClientMap");
    src_XkbFreeServerMap = (PFN_XkbFreeServerMap)load_fn("XkbFreeServerMap");
    src_XkbAddKeyType = (PFN_XkbAddKeyType)load_fn("XkbAddKeyType");
    src_XkbAllocIndicatorMaps = (PFN_XkbAllocIndicatorMaps)load_fn("XkbAllocIndicatorMaps");
    src_XkbFreeIndicatorMaps = (PFN_XkbFreeIndicatorMaps)load_fn("XkbFreeIndicatorMaps");
    src_XkbGetMap = (PFN_XkbGetMap)load_fn("XkbGetMap");
    src_XkbGetUpdatedMap = (PFN_XkbGetUpdatedMap)load_fn("XkbGetUpdatedMap");
    src_XkbGetMapChanges = (PFN_XkbGetMapChanges)load_fn("XkbGetMapChanges");
    src_XkbRefreshKeyboardMapping = (PFN_XkbRefreshKeyboardMapping)load_fn("XkbRefreshKeyboardMapping");
    src_XkbGetKeyTypes = (PFN_XkbGetKeyTypes)load_fn("XkbGetKeyTypes");
    src_XkbGetKeySyms = (PFN_XkbGetKeySyms)load_fn("XkbGetKeySyms");
    src_XkbGetKeyActions = (PFN_XkbGetKeyActions)load_fn("XkbGetKeyActions");
    src_XkbGetKeyBehaviors = (PFN_XkbGetKeyBehaviors)load_fn("XkbGetKeyBehaviors");
    src_XkbGetVirtualMods = (PFN_XkbGetVirtualMods)load_fn("XkbGetVirtualMods");
    src_XkbGetKeyExplicitComponents = (PFN_XkbGetKeyExplicitComponents)load_fn("XkbGetKeyExplicitComponents");
    src_XkbGetKeyModifierMap = (PFN_XkbGetKeyModifierMap)load_fn("XkbGetKeyModifierMap");
    src_XkbGetKeyVirtualModMap = (PFN_XkbGetKeyVirtualModMap)load_fn("XkbGetKeyVirtualModMap");
    src_XkbAllocControls = (PFN_XkbAllocControls)load_fn("XkbAllocControls");
    src_XkbFreeControls = (PFN_XkbFreeControls)load_fn("XkbFreeControls");
    src_XkbGetControls = (PFN_XkbGetControls)load_fn("XkbGetControls");
    src_XkbSetControls = (PFN_XkbSetControls)load_fn("XkbSetControls");
    src_XkbNoteControlsChanges = (PFN_XkbNoteControlsChanges)load_fn("XkbNoteControlsChanges");
    src_XkbAllocCompatMap = (PFN_XkbAllocCompatMap)load_fn("XkbAllocCompatMap");
    src_XkbFreeCompatMap = (PFN_XkbFreeCompatMap)load_fn("XkbFreeCompatMap");
    src_XkbGetCompatMap = (PFN_XkbGetCompatMap)load_fn("XkbGetCompatMap");
    src_XkbSetCompatMap = (PFN_XkbSetCompatMap)load_fn("XkbSetCompatMap");
    src_XkbAddSymInterpret = (PFN_XkbAddSymInterpret)load_fn("XkbAddSymInterpret");
    src_XkbAllocNames = (PFN_XkbAllocNames)load_fn("XkbAllocNames");
    src_XkbGetNames = (PFN_XkbGetNames)load_fn("XkbGetNames");
    src_XkbSetNames = (PFN_XkbSetNames)load_fn("XkbSetNames");
    src_XkbChangeNames = (PFN_XkbChangeNames)load_fn("XkbChangeNames");
    src_XkbFreeNames = (PFN_XkbFreeNames)load_fn("XkbFreeNames");
    src_XkbGetState = (PFN_XkbGetState)load_fn("XkbGetState");
    src_XkbSetMap = (PFN_XkbSetMap)load_fn("XkbSetMap");
    src_XkbChangeMap = (PFN_XkbChangeMap)load_fn("XkbChangeMap");
    src_XkbSetDetectableAutoRepeat = (PFN_XkbSetDetectableAutoRepeat)load_fn("XkbSetDetectableAutoRepeat");
    src_XkbGetDetectableAutoRepeat = (PFN_XkbGetDetectableAutoRepeat)load_fn("XkbGetDetectableAutoRepeat");
    src_XkbSetAutoResetControls = (PFN_XkbSetAutoResetControls)load_fn("XkbSetAutoResetControls");
    src_XkbGetAutoResetControls = (PFN_XkbGetAutoResetControls)load_fn("XkbGetAutoResetControls");
    src_XkbSetPerClientControls = (PFN_XkbSetPerClientControls)load_fn("XkbSetPerClientControls");
    src_XkbGetPerClientControls = (PFN_XkbGetPerClientControls)load_fn("XkbGetPerClientControls");
    src_XkbCopyKeyType = (PFN_XkbCopyKeyType)load_fn("XkbCopyKeyType");
    src_XkbCopyKeyTypes = (PFN_XkbCopyKeyTypes)load_fn("XkbCopyKeyTypes");
    src_XkbResizeKeyType = (PFN_XkbResizeKeyType)load_fn("XkbResizeKeyType");
    src_XkbResizeKeySyms = (PFN_XkbResizeKeySyms)load_fn("XkbResizeKeySyms");
    src_XkbResizeKeyActions = (PFN_XkbResizeKeyActions)load_fn("XkbResizeKeyActions");
    src_XkbChangeTypesOfKey = (PFN_XkbChangeTypesOfKey)load_fn("XkbChangeTypesOfKey");
    src_XkbChangeKeycodeRange = (PFN_XkbChangeKeycodeRange)load_fn("XkbChangeKeycodeRange");
    src_XkbListComponents = (PFN_XkbListComponents)load_fn("XkbListComponents");
    src_XkbFreeComponentList = (PFN_XkbFreeComponentList)load_fn("XkbFreeComponentList");
    src_XkbGetKeyboard = (PFN_XkbGetKeyboard)load_fn("XkbGetKeyboard");
    src_XkbGetKeyboardByName = (PFN_XkbGetKeyboardByName)load_fn("XkbGetKeyboardByName");
    src_XkbKeyTypesForCoreSymbols = (PFN_XkbKeyTypesForCoreSymbols)load_fn("XkbKeyTypesForCoreSymbols");
    src_XkbApplyCompatMapToKey = (PFN_XkbApplyCompatMapToKey)load_fn("XkbApplyCompatMapToKey");
    src_XkbUpdateMapFromCore = (PFN_XkbUpdateMapFromCore)load_fn("XkbUpdateMapFromCore");
    src_XkbAddDeviceLedInfo = (PFN_XkbAddDeviceLedInfo)load_fn("XkbAddDeviceLedInfo");
    src_XkbResizeDeviceButtonActions = (PFN_XkbResizeDeviceButtonActions)load_fn("XkbResizeDeviceButtonActions");
    src_XkbAllocDeviceInfo = (PFN_XkbAllocDeviceInfo)load_fn("XkbAllocDeviceInfo");
    src_XkbFreeDeviceInfo = (PFN_XkbFreeDeviceInfo)load_fn("XkbFreeDeviceInfo");
    src_XkbNoteDeviceChanges = (PFN_XkbNoteDeviceChanges)load_fn("XkbNoteDeviceChanges");
    src_XkbGetDeviceInfo = (PFN_XkbGetDeviceInfo)load_fn("XkbGetDeviceInfo");
    src_XkbGetDeviceInfoChanges = (PFN_XkbGetDeviceInfoChanges)load_fn("XkbGetDeviceInfoChanges");
    src_XkbGetDeviceButtonActions = (PFN_XkbGetDeviceButtonActions)load_fn("XkbGetDeviceButtonActions");
    src_XkbGetDeviceLedInfo = (PFN_XkbGetDeviceLedInfo)load_fn("XkbGetDeviceLedInfo");
    src_XkbSetDeviceInfo = (PFN_XkbSetDeviceInfo)load_fn("XkbSetDeviceInfo");
    src_XkbChangeDeviceInfo = (PFN_XkbChangeDeviceInfo)load_fn("XkbChangeDeviceInfo");
    src_XkbSetDeviceLedInfo = (PFN_XkbSetDeviceLedInfo)load_fn("XkbSetDeviceLedInfo");
    src_XkbSetDeviceButtonActions = (PFN_XkbSetDeviceButtonActions)load_fn("XkbSetDeviceButtonActions");
    src_XkbToControl = (PFN_XkbToControl)load_fn("XkbToControl");
    src_XkbSetDebuggingFlags = (PFN_XkbSetDebuggingFlags)load_fn("XkbSetDebuggingFlags");
    src_XkbApplyVirtualModChanges = (PFN_XkbApplyVirtualModChanges)load_fn("XkbApplyVirtualModChanges");
    src_XkbUpdateActionVirtualMods = (PFN_XkbUpdateActionVirtualMods)load_fn("XkbUpdateActionVirtualMods");
    src_XkbUpdateKeyTypeVirtualMods = (PFN_XkbUpdateKeyTypeVirtualMods)load_fn("XkbUpdateKeyTypeVirtualMods");
}